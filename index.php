...
<table id='a' class='center'>
    <tr>
        ...
        <td class='$default2b'><a href='./courses.html' class='p'><h4>Enrolled Courses</h4></a> <hr> <ol> <li>CS4413</li> <li>CS4683</li> <li>CS3733</li> </ol> <br> <h4>Theme Toggles</h4><hr> <form action='index.php' method='POST'> <input type='submit' class='button' value = 'UTSA Theme' name='uni' /> </form> <form action='index.php' method='POST'> <input type='submit' class='button' value = 'Dark Mode' name='dm' /> </form></td>
    </tr>
</table>
<table width='100%'>
    <tr>
